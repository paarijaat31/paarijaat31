...
class Paarijaat:
    def __init__(self):
        self.role           = "Financial Due Diligence Intern @ KPMG India (Transaction Services)"
        self.education       = "ASU W. P. Carey School of Business, Class of 2027"
        self.majors           = ["Finance", "Business Data Analytics", "Supply Chain Management"]
        self.minor            = "Real Estate"
